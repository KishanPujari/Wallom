...
Write-Host "${colorPink} * ${colorGray} = Mine (X1, lasts 5 turns, max 5 active)"
...
Write-Host "${colorGray}- Mines expire after 5 turns"
Write-Host "${colorGray}- Max 5 active mines allowed"
Write-Host ""
